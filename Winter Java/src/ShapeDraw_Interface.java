...
public class ShapeDraw_Interface extends JApplet {
   ...
   public void init() {  
      ...
      colorChoice.addItem("Glurtelskletch");
      ...
      JButton secovalButton = new JButton("SecOval");
      secovalButton.addActionListener(canvas);
   ...
   static class ShapeCanvas extends JPanel
      ...
      public void actionPerformed(ActionEvent evt) {
    	  ...
    	  Color glurtelskletch = new Color(192, 116, 145);
         if (evt.getSource() instanceof JComboBox) {
            switch ( ((JComboBox)evt.getSource()).getSelectedIndex() ) {
               ...
               case 8: currentColor = glurtelskletch;	break;
            }
         }
         else {
            ...
            else if (command.equals("SecOval"))
                addShape(new SecOvalShape());
            }
      }
  ...
  static interface Shape {
	  ...
	  int left = 0, top = 0;      // Position of top left corner of rectangle that bounds this shape.
      int width = 0, height = 0;  // Size of the bounding rectangle.      
   ...
   public static class OvalShape implements Shape {
	   int left = 0, top = 0;      // Position of top left corner of rectangle that bounds this shape.
	      int width = 0, height = 0;  // Size of the bounding rectangle.      
	      Color color = Color.white;  // Color of this shape.
   ...
   public static class RoundRectShape implements Shape {
   ...
   public static class SecOvalShape implements Shape {

	   int left = 0, top = 0;      // Position of top left corner of rectangle that bounds this shape.
	      int width = 0, height = 0;  // Size of the bounding rectangle.      
	      Color color = Color.white;  // Color of this shape.
       // This class represents modified oval shapes.
	    public void reshape(int left, int top, int width, int height) {
	            // Set the position and size of this shape.
	         this.left = left;
	         this.top = top;
